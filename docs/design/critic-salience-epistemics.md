...
- **Reclamation pass**: a periodic researcher sweep of the graveyard — promote dormants that acquired a second mention, or fold them into canonical entries via the merge queue. The graveyard is the researcher's inbox.
