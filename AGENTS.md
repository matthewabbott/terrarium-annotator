...
4. `docs/plan/v2-foundation.md` — sequenced build tasks + autonomous-run guardrails (start here when coding)
5. `docs/design/dev-verification.md` — test layers for agent-driven development (L0–L5)
6. `docs/design/wiki-format.md` — target wiki page conventions (from the live steelbea.me wiki)
7. `docs/design/context-improvements.md` — pre-cutover design notes (historical, still useful)
8. `docs/worklog/` — what happened recently
